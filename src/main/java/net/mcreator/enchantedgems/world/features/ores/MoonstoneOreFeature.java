...
public class MoonstoneOreFeature extends OreFeature {
	public static MoonstoneOreFeature FEATURE = null;
	...
	private static class MoonstoneOreFeatureRuleTest extends RuleTest {
		...
		private static final com.mojang.serialization.Codec<MoonstoneOreFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<MoonstoneOreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("enchanted_gems:moonstone_ore_match"), CUSTOM_MATCH);
		}
