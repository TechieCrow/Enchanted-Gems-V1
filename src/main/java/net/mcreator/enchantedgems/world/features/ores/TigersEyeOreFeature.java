...
public class TigersEyeOreFeature extends OreFeature {
	public static TigersEyeOreFeature FEATURE = null;
	...
	private static class TigersEyeOreFeatureRuleTest extends RuleTest {
		static final TigersEyeOreFeatureRuleTest INSTANCE = new TigersEyeOreFeatureRuleTest();
		private static final com.mojang.serialization.Codec<TigersEyeOreFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<TigersEyeOreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("enchanted_gems:tigers_eye_ore_match"), CUSTOM_MATCH);
		}
